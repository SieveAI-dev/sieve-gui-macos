...
| 编号 | 状态 | 模块 |
|-----|------|------|
| [SPEC-001](SPEC-001-menu-bar-and-quick-menu.md) | Stable | 菜单栏 + Quick Menu |
| [SPEC-002](SPEC-002-hips-popup-window.md) | Stable | HIPS 弹窗（GUI 渲染规格）|
| [SPEC-003](SPEC-003-settings-window.md) | Stable | 设置窗口 6 个 Tab |
| [SPEC-004](SPEC-004-history-window.md) | Stable | 历史窗口 + Touch ID + 导出 |
| [SPEC-005](SPEC-005-debug-window.md) | Stable | 调试窗口 4 个 Tab |
| [SPEC-006](SPEC-006-onboarding-flow.md) | Stable | 6 步引导 + 权限矩阵 |
| [SPEC-007](SPEC-007-toast-and-system-notifications.md) | Stable | 状态栏 Toast + macOS 通知 |
| [SPEC-008](SPEC-008-ipc-client.md) | Stable | GUI 侧 IPC 客户端实现 |
